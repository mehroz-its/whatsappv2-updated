            ...
            <Card>
                <div style={{ width: '350px' }}>
                    <CardContent style={{ padding: '10px 10px' }} >
                        ...
                        <p id="attachmentDate" style={{ width: "100%", margin: '10px', marginLeft: '1%', fontSize: '10px' }}>{moment(message.dt).format('MMM Do YY, h:mm A')} {message.type === "outbound" && !message.hideStatus  ? MessageStateResolver.resolve(message.status) : null}</p>
