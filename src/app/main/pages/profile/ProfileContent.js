...
const Profile = function (props) {
    ...
    React.useEffect(() => {
        loadProfile().then((response) => {
            ...
            setstatee(profileData[10].state)
            ...
            if (profileData[10].state !== "N/A" && profileData[10].state !== "") {
                                    ...
                                    <Grid key={`user_attribute_grid_holder_${i}`} item md={6} xs={12}>
                                        <div key={`user_attribute_data_holder_${i}`} style={{ marginBottom: 20 }} >
                                            <TextField
                                                ...
                                                autoFocus
                                                label={`${keys[1].toUpperCase()}` === 'ADDRESS' ? 'ADDRESS' : `${keys[1].toUpperCase()}` === 'FIRSTNAME' ? 'FIRSTNAME' : `${keys[1].toUpperCase()}` === 'LASTNAME' ? 'LASTNAME' : `${keys[1].toUpperCase()}` === 'AGE' ? 'AGE' : `${keys[1].toUpperCase()}` === 'GENDER' ? 'GENDER' : `${keys[1].toUpperCase()}` === 'CNIC' ? 'CNIC' : `${keys[1].toUpperCase()}` === "DOB" ? null : `${keys[1].toUpperCase()}` === 'COUNTRY' ? 'COUNTRYY' : `${keys[1].toUpperCase()}` === "CITY" ? "CITY" : `${keys[1].toUpperCase()}` === "IMAGE" ? "IMAGE" : null}
                                                variant="outlined"
                                                fullWidth
                                                autoComplete="off"
